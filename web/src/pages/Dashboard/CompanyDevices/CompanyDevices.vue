        ...
        <div class="row">
            <div class="col-12">
                <card card-body-classes="table-full-width" no-footer-line>
                    <div slot="header">
                        <h4 class="card-title">Dispositivos por empresa</h4>
                        <btn class="btn btn-success btn-round pull-right"
                             data-original-title=""
                             title=""
                             @click="callModalCompanyDevices(null)">
...
<script>
  ...
  import ModalCompanyDevices from "../Companies/ModalCompanyDevices";
  ...
  export default {
    ...
    methods: {
      handleEdit(index, row) {
        this.callModalCompanyDevices(row);
      },
      ...
      callModalCompanyDevices(companyDevice) {
        const params = {
          isVisible: true,
